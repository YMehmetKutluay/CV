...
tribble(
  ...
  "In a small team (4-5 FTE's) of only data scientists, working on multiple projects with different stakeholders. Currently these are fraud detection, credit risk scoring and satellite database creation",
  Apollo[1], Apollo[2], Apollo[3], Apollo[4],
