...
* Statistics/Data Science: R, Python, Matlab
...
tribble(
  ...
  "Part of a big team of 40-45 FTE's that develop models to detect money laundering and other illegal financial activities",
  ING_fec[1], ING_fec[2], ING_fec[3], ING_fec[4],
  "Creating two containerized (via Docker) Python packages for: 1. streamlined unsupervised anomaly detection and 2. extracting network features from transaction data",
  ING_fec[1], ING_fec[2], ING_fec[3], ING_fec[4],
  ...
  ING_finance[1], ING_finance[2], ING_finance[3], ING_finance[4],
    "Coaching trainees and interns in data science work",
  ING_finance[1], ING_finance[2], ING_finance[3], ING_finance[4],
