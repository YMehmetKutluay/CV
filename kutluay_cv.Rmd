...
tribble(
  ...
  TMNL[1], TMNL[2], TMNL[3], TMNL[4],
  "Created/maintained two Python packages for network analytics projects: 1. efficient network traversals and 2. detecting communities within networks. Infrastructure environment: AWS",
  TMNL[1], TMNL[2], TMNL[3], TMNL[4],
