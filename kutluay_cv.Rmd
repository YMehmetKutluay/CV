...
* Network Analytics, Anomaly Detection, Docker, Spark, Time Series Forecasting, Cross-Sectional Prediction,  Data Visualization, Data Wrangling
...
Apollo <- c("Senior Data Scientist", "Apollo Agriculture", "May 2022 - Present", "Amsterdam")
# Define information on TMNL
TMNL <- c("Senior Data Scientist", "Transactie Monitoring Nederland", "May 2021 - May 2022", "Purmerend")
...
tribble(
  ...
  "In a small team (4-5 FTE's) of only data scientists, working on multiple projects with different stakeholders. Currently these are fraud detection and credit risk scoring",
  Apollo[1], Apollo[2], Apollo[3], Apollo[4],
  ...
  Apollo[1], Apollo[2], Apollo[3], Apollo[4],
  "Mentoring junior and medior data scientist",
  # TMNL
  TMNL[1], TMNL[2], TMNL[3], TMNL[4],
  "In multifunctional department, consisting of data scientists and anti-money laundering experts",
  TMNL[1], TMNL[2], TMNL[3], TMNL[4],
  "Created/maintained two Python packages for network analytics projects: 1. efficient network traversals and 2. detecting communities within networks",
  TMNL[1], TMNL[2], TMNL[3], TMNL[4],
  "Main linking pin with engineering teams to ensure a workable framework for model development",
  TMNL[1], TMNL[2], TMNL[3], TMNL[4],
  "Mentoring other data scientists and integrating anti-money laundering experts actively into analytics projects",
  TMNL[1], TMNL[2], TMNL[3], TMNL[4],
