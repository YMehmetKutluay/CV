...
tribble(
  ...
  Sam[1], Sam[2], Sam[3], Sam[4],
  "Building the data strategy from scratch and implementing governance. Strong focus on making the data team a business partner to key projects and teams in the company.",
  # Knab
