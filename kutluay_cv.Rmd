...
Knab <- c("Lead Data Scientist", "Knab", "August 2023 - Present", "Amsterdam")
...
tribble(
  ...
  "Initially joined as senior data scientist, working as lead data scientist since March 2024.",
  Knab[1], Knab[2], Knab[3], Knab[4],
  "Leading a team of 6-7 data scientists, while also working on model development and productionization.",
  Knab[1], Knab[2], Knab[3], Knab[4],
  "Deployed first machine learning models for the bank. Currently working with different senior stakeholders in the bank (including data engineering and model risk management) to make this process smoother",
  Knab[1], Knab[2], Knab[3], Knab[4],
