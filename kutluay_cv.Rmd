...
Sam <- c("Head of Data", "Sam Media", "September 2025 - Present", "Amsterdam")
...
tribble(
  ...
  "Heading the central data team of 4-5 FTE's consisting of data analysts and data engineers.",
  Sam[1], Sam[2], Sam[3], Sam[4],
  "Guiding data product development, coordinating team members across different squads and setting priorities.",
  Sam[1], Sam[2], Sam[3], Sam[4],
  "Providing soft skills mentorship and guidance to team members.",
  # Knab
  Knab[1], Knab[2], Knab[3], Knab[4],
  "Initially joined as senior data scientist, worked as lead data scientist from March 2024.",
  Knab[1], Knab[2], Knab[3], Knab[4],
  "Lead a team of 6-7 data scientists, and also worked on model development and productionization.",
  Knab[1], Knab[2], Knab[3], Knab[4],
  "Deployed first machine learning models for the bank, mainly within the KYC sphere. Set up and developed the governance and technical framework for deploying more models. This was in collaboration with many parties (data engineering, data governance, business stakeholders and model risk management).",
  Knab[1], Knab[2], Knab[3], Knab[4],
  "Was responsible for moulding and executing the ML / AI strategy of Knab, as well as mentoring other data scientists and leading by example.",
  # Apollo
