...
* Time Series Data, Cross-Sectional Data, Anomaly Detection, Data Visualization, Data Wrangling, Dashboarding

## Languages

* Statistics/Data Science: R, Stata (both advanced), Python, Matlab, SPSS, Eviews

* Other: Latex, Microsoft Office, Markdown

## Applications

* RStudio, Spyder, Jupyter Notebook, Git Bash, Notepad++, SAS EG
...
phd <- c("PhD Researcher in Environmental Economics", "A University in the Netherlands", "Sep 2014 - Aug 2018", "The Netherlands")
# Define information on teaching assistant
teaching_assistant <- c("Teaching Assistant", "A University in the Netherlands", "Sep 2013 - Feb 2018", "The Netherlands")
...
tribble(
  ...
  ING_finance[1], ING_finance[2], ING_finance[3], ING_finance[4],
  "Create R packages for time series forecasting, detecting/correcting anomalies and data exploration",
  ING_finance[1], ING_finance[2], ING_finance[3], ING_finance[4],
...
MSc_info <- c("MPhil in Economics", "A University in the Netherlands", "A University in the Netherlands","Sep 2012 - Aug 2014")
# Define information on Bachelor
BSc_info <- c("BSc in Economics", "A University in Turkey", "A University in Turkey", "Sep 2008 - Jun 2012")
# Combine all information
tribble(
